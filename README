...
of private clouds, PCMONS was developed. It is intended to be an extensible and modular 
monitoring system for private clouds. In its first release, PCMONS acts principally retrieving, 
gathering and preparing relevant information for monitoring data visualization and is specially 
on virtual machines.

Authors: Shirlei Chaves (shirlei@inf.ufsc.br), Rafael Uriarte (rafael.uriarte@inf.ufsc.br)
...
II. PREREQUISITES:
-----------------------------------------------------------------
The first release of PCMONS is compatible with Eucalyptus (IaaS platform) and Nagios (used 
specially to visualize monitoring data). However, its development considers easily integration 
with other toolkit or cloud frameworks, like OpenNebula, through the development of extensions.
...
Ex: yum install python MySQL-python python-boto mysql-server
